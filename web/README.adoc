...
Also includes a single-process fullstack <<heroku-deployment>> by building the https://github.com/gothinkster/frontend statically and serving it from the public folder of the backend.
